...
// st4、创建使用地图的组件，配置组件路由，并在该组件中，创建一个容器用于展示地图，并继承让组件容器与地图容器继承根组件的100%高度
...
// N03、要么在样式文件中将css选择器改成css-modules的全局模式，即:global(#map)，那么st5传入的地图容器id就是 new window.BMap.Map('map')